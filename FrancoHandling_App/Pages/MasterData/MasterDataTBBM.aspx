<%@ Page Title="TBBM" Language="C#" AutoEventWireup="true" MasterPageFile="~/Layout.master" CodeBehind="MasterDataTBBM.aspx.cs" Inherits="FrancoHandling_App.Pages.MasterData.MasterDataTBBM" %>
            ...
            <dx:ASPxPanel ID="panGv" ClientInstanceName="panGV" Width="100%" runat="server" ScrollBars="Horizontal">
                <PanelCollection>
                    <dx:PanelContent>
                        ...
                        <dx:BootstrapGridView ID="gv" ClientInstanceName="gv" runat="server" KeyFieldName="TBBM_ID_PK" AutoGenerateColumns="False"
                            ...
                            <SettingsText PopupEditFormCaption="Add / Edit TBBM"/>
                            ...
                            <Columns>
                                ...
                                <dx:BootstrapGridViewTextColumn FieldName="Name" Caption="Nama TBBM" Settings-AllowDragDrop="False"></dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewDataColumn FieldName="Region_ID_FK" Visible="false" Settings-AllowDragDrop="False"></dx:BootstrapGridViewDataColumn>
                            ...
                            <Templates>
                                <EditForm>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <dx:BootstrapTextBox runat="server" ID="txtName" Caption="Nama TBBM" Text='<%# Eval("Name") %>'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="text-align:center">
                                            <dx:BootstrapButton runat="server" ID="btnUpdate" ClientInstanceName="btnUpdate" CssClasses-Control="btn-success" Text="Save" AutoPostBack="false" Width="150px">
