<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="PrintInvoiceReport.aspx.cs" Inherits="FrancoHandling_App.Report.PrintInvoiceReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <dx:BootstrapCallbackPanel ID="cBackReport" ClientInstanceName="cBackReport" runat="server" 
                    OnCallback="cBackReport_Callback">
                    <ContentCollection>
                        <dx:ContentControl>
