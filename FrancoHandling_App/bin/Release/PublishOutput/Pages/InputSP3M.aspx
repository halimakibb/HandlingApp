...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxHiddenField ID="hfSP3MId" runat="server"></dx:ASPxHiddenField>
<div class="container">
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <dx:BootstrapComboBox runat="server" ID="cmbForce" ClientInstanceName="cmbForce" Caption="Angkatan" ValueField="Force" TextField="Force">
                <ValidationSettings RequiredField-IsRequired="true" RequiredField-ErrorText="Field is Required"></ValidationSettings>
                ...
                <dx:BootstrapGridViewComboBoxColumn Name="cmbProduct" FieldName="ProductName" Caption="Produk" >                    
                    <PropertiesComboBox ValueField ="Product_ID_PK" TextField="Name">
                        ...
                        <Items>
                            ...
                            <dx:BootstrapListEditItem Value="6" Text="TURBO" />
                        </Items>
                    </PropertiesComboBox>
                </dx:BootstrapGridViewComboBoxColumn>
                <dx:BootstrapGridViewSpinEditColumn FieldName="QuantityVolume" Caption="Kuantitas">
                    <PropertiesSpinEdit ClientInstanceName="Quantity" MaxLength="8" NumberType="Float" DisplayFormatString="{0:N0} Liter" DisplayFormatInEditMode="true"
