                    ...
                    <dx:PanelContent>
                        <dx:BootstrapGridView ID="gv" ClientInstanceName="gv" runat="server" KeyFieldName="TBBM_ID;SPSH_ID" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dx:BootstrapGridViewSpinEditColumn FieldName="Distance" Caption="Jarak" PropertiesSpinEdit-NumberType="Integer" PropertiesSpinEdit-DisplayFormatString="{0:N0} KM" PropertiesSpinEdit-DisplayFormatInEditMode="true"  Settings-AllowDragDrop="False"/>
                                <dx:BootstrapGridViewSpinEditColumn FieldName="NormalRate" Caption="Tarif Angkut" PropertiesSpinEdit-NumberType="Integer" PropertiesSpinEdit-DisplayFormatString="{0:N0} IDR" PropertiesSpinEdit-DisplayFormatInEditMode="true"  Settings-AllowDragDrop="False"/>
                                <dx:BootstrapGridViewSpinEditColumn FieldName="SpecialRate" Caption="Tarif >40 KM" PropertiesSpinEdit-NumberType="Integer" PropertiesSpinEdit-DisplayFormatString="{0:N0} IDR" PropertiesSpinEdit-DisplayFormatInEditMode="true"  Settings-AllowDragDrop="False"/>
                            </Columns>
