...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <dx:BootstrapButton runat="server" ID="btnAdd" ClientInstanceName="btnAdd" Text="Tambah DO" style="background-color:#0477C0; color:white" AutoPostBack="false" CausesValidation="true">
            ...
            <dx:BootstrapGridView ID="gridInvoiceItem" ClientInstanceName="gridInvoiceItem" runat="server" KeyFieldName="LO_ID;Product_ID" 
                ...
                <Columns>
                    ...
                    <dx:BootstrapGridViewDataColumn FieldName="NoDO" Caption="Nomor DO"  ReadOnly="true" />
